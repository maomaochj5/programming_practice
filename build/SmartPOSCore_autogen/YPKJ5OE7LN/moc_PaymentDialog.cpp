...
#include "../../../src/ui/PaymentDialog.h"
...
template <> constexpr inline auto PaymentDialog::qt_create_metaobjectdata<qt_meta_tag_ZN13PaymentDialogE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Slot 'onPaymentMethodChanged'
        QtMocHelpers::SlotData<void()>(1, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'onCashAmountChanged'
        QtMocHelpers::SlotData<void()>(3, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'calculateChange'
        QtMocHelpers::SlotData<void()>(4, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'processPayment'
        QtMocHelpers::SlotData<void()>(5, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'cancelPayment'
        QtMocHelpers::SlotData<void()>(6, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'simulateCardPayment'
        QtMocHelpers::SlotData<void()>(7, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'simulateMobilePayment'
        QtMocHelpers::SlotData<void()>(8, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'onPaymentTimeout'
...
void PaymentDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->onPaymentMethodChanged(); break;
        case 1: _t->onCashAmountChanged(); break;
        case 2: _t->calculateChange(); break;
        case 3: _t->processPayment(); break;
        case 4: _t->cancelPayment(); break;
        case 5: _t->simulateCardPayment(); break;
        case 6: _t->simulateMobilePayment(); break;
        case 7: _t->onPaymentTimeout(); break;
        default: ;
        }
    }
    (void)_a;
