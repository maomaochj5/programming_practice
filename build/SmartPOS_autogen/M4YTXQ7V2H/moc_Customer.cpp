...
void Customer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->customerChanged(); break;
        case 1: _t->loyaltyPointsChanged((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Customer::*)()>(_a, &Customer::customerChanged, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (Customer::*)(int )>(_a, &Customer::loyaltyPointsChanged, 1))
            return;
    }
}
...
// SIGNAL 0
void Customer::customerChanged()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void Customer::loyaltyPointsChanged(int _t1)
{
